...
const PlanItem = ({
  ...
  return (
    <div className="relative flex max-w-80 flex-col justify-center rounded-2xl border-[3px] border-blue-500 px-5 py-5 transition duration-300 sm:w-96 hover:-translate-y-5 bg-white">
